 ...
 * Use this version of the script if you're using the AudioSpectrum script in the scene.
 */
...
public class VisualizationElement : MonoBehaviour
{
    ...
    private void Update()
    {
        transform.localScale = new Vector3(transform.localScale.x, AudioSpectrum.bandBuffers[band], transform.localScale.z);
